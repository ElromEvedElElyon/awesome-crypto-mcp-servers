...
- **[claw-mcp-toolkit](https://github.com/ElromEvedElElyon/claw-mcp-toolkit)** - All-in-one MCP server with 26 tools across 5 modules (crypto, web, social, finance, productivity). Crypto prices, Fear & Greed, trending, market cap, stock prices, forex, SEO, tweets, invoices. Zero config. MIT license.
