...
- **[chainlink-sentinel](https://github.com/ElromEvedElElyon/chainlink-sentinel)** - AI-powered cross-chain risk monitor using Chainlink Data Feeds. 6 MCP tools reading 30+ price feeds across 6 EVM chains (Ethereum, Polygon, Arbitrum, Base, Avalanche, BNB). Detects stale oracles, stablecoin depegs, and cross-chain price deviations. Zero API keys.
