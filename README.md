...
- **[runes-busd1-mcp](https://github.com/ElromEvedElElyon/flash-payment-system)** - First write-capable Bitcoin Runes MCP server. Mint, transfer, list BITCOIN•USD•ONE. USD stablecoin (bUSD1) backed 1:1 with Chainlink PoR. 12 tools.
